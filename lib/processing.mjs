...
export function transcriptFailure(error) {
  ...
  if (isTranscriptLimit(message)) return {
    ...
    summary: "This Reel is saved. Transcription reached a usage or request limit. Check the provider connections before retrying, or add the useful text as context."
  };
  return {
